...
(پورت برای هر کانفیگ محزا و به صورت رندوم تولید میشه، البته قابل تغییر دستیه)

(در بخش tls فیلد های مشخص شده رو همون دو تا آدرس بالا وارد کنید: `/root/cert.crt` و `/root/private.key`)
